...
class Display2D(object):
  def __init__(self, W, H):
    ...
    self.surface = pygame.Surface(self.screen.get_size()).convert_alpha()
  def paint(self, img):
    # junk
    ...
    if(imgIdent%3 ==0):
      pygame.display.flip()
    ## code to get every 10th frame and write it to /images
    if(imgIdent%20 ==0):
      global imgIdent
      var = "/home/nick/slam/vid1/image" + str(imgIdent) + ".jpg"
      pygame.image.save(self.screen,var)
      os.system('python3 trained.py '+str(var))
      print('python3 trained.py '+str(var))
      #os.system('python3 trained.py')
    imgIdent += 1
